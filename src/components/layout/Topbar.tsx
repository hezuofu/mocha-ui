  ...
  return (
    <div className="topbar" style={{
      ...
      <div className="topbar-chips" style={{ display: 'flex', gap: 6, alignItems: 'center', flexShrink: 0 }}>
        <button onClick={() => handleExport('markdown')} className="panel-icon-btn" title="Download as Markdown"
        ...
        <button onClick={() => handleExport('json')} className="panel-icon-btn" title="Export as JSON"
          style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '4px 10px', fontSize: 11, border: '1px solid var(--border)', borderRadius: 6, background: 'transparent', color: 'var(--muted)', cursor: 'pointer' }}>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
          Export
        </button>
        <button onClick={handleClear} className="panel-icon-btn" title="Clear conversation"
